 ...
 */
class getJetonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\JetonRepository' shared autowired service.
     *
     * @return \App\Repository\JetonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JetonRepository.php';

        return $container->privates['App\\Repository\\JetonRepository'] = new \App\Repository\JetonRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
