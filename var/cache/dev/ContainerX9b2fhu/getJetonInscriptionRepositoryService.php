 ...
 */
class getJetonInscriptionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\JetonInscriptionRepository' shared autowired service.
     *
     * @return \App\Repository\JetonInscriptionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JetonInscriptionRepository.php';

        return $container->privates['App\\Repository\\JetonInscriptionRepository'] = new \App\Repository\JetonInscriptionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
